...
| `python scripts/dedupe_cloud.py --yes` | Merge the same job listed under different company spellings; dry run without `--yes`. See [docs/DATABASE.md](docs/DATABASE.md#duplicates) |
